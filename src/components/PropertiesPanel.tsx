    ...
    return (
        <div className="studio-properties-panel z-10 h-full space-y-4 overflow-y-auto rounded-[1.35rem] border p-3.5 shadow-sm">
            ...
            <div className="studio-inspector-stack">
                ...
                <div className="studio-inspector-field">
                    ...
                    <div className="studio-inspector-alignment-grid studio-inspector-icon-grid">
                        ...
                        <button
                            ...
                            title="Align Top"
                        >
                            <ArrowUp size={16} className="rotate-0" />
                        </button>
                        <button
                ...
                {/* Layering */}
                <div className="studio-inspector-field">
                    <label className="studio-inspector-field-label">Layer Order</label>
                ...
                <div className="studio-inspector-metrics-grid">
                    <div className="studio-inspector-field">
                        ...
                        <input
                            ...
                            className="studio-input px-3 py-2 text-sm outline-none"
                        />
                    </div>
                    <div className="studio-inspector-field">
                ...
                {/* Rotation */}
                <div className="studio-inspector-field">
                    <label className="studio-inspector-field-label">Rotation ({Math.round(effectiveElement.rotation || 0)} deg)</label>
                ...
                <div className="flex items-center gap-2 pt-0.5">
                    ...
                    />
                    <label htmlFor="aspectRatioLock" className="cursor-pointer text-sm font-medium text-slate-700">Lock Aspect Ratio</label>
                </div>
            </div>
            </InspectorSection>
                ...
                <InspectorSection title="Copy Settings" className="border-t border-gray-200 pt-4">
                    ...
                    <div className="studio-inspector-field">
                        ...
                        <select
                            ...
                            className="studio-select px-3 py-2 text-sm text-black bg-white"
                        >
                            {fonts.map(font => (
                        ...
                        <div className="studio-inspector-field">
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="h-9 w-9 p-1 border border-gray-300 rounded-lg cursor-pointer"
                                />
                                <input
                                    type="text"
                                    value={effectiveElement.style?.color || '#000000'}
                    ...
                    <div className="space-y-2">
                        <h5 className="text-[0.68rem] font-bold uppercase tracking-[0.08em] text-slate-500">Text Alignment</h5>
                        <div className="grid grid-cols-1 gap-2.5">
                            <div className="studio-inspector-text-row flex items-center gap-2">
                                <div className="flex-1">
                                    <label className="mb-1 block text-[10px] font-bold uppercase text-gray-400">Horizontal</label>
                                    <div className="studio-inspector-segmented">
                                        <button
                                            onClick={() => handleStyleChange('textAlign', 'left')}
                                            className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.textAlign === 'left' ? 'bg-emerald-100 text-emerald-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                            title="Align Left"
                                        >
                                            <AlignLeft size={16} />
                                        </button>
                                        <button
                                            ...
                                            className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.textAlign === 'center' || !effectiveElement.style?.textAlign ? 'bg-emerald-100 text-emerald-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                            title="Align Center"
                                        >
                                            <AlignCenter size={16} />
                                        </button>
                                        <button
                                            ...
                                            className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.textAlign === 'right' ? 'bg-emerald-100 text-emerald-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                            title="Align Right"
                                        >
                                            <AlignRight size={16} />
                                        </button>
                                ...
                                <div className="studio-inspector-direction">
                                    <label className="mb-1 block text-[10px] font-bold uppercase text-gray-400">Direction</label>
                                    <div className="studio-inspector-segmented">
                                        <button
                                            onClick={() => handleStyleChange('direction', 'ltr')}
                                            className={`studio-inspector-segmented-button flex-1 flex justify-center text-[11px] font-bold ${effectiveElement.style?.direction === 'ltr' || !effectiveElement.style?.direction ? 'bg-teal-100 text-teal-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                            title="Left-to-Right"
                                        >
                                            LTR
                                        </button>
                                        <button
                                            ...
                                            className={`studio-inspector-segmented-button flex-1 flex justify-center text-[11px] font-bold ${effectiveElement.style?.direction === 'rtl' ? 'bg-teal-100 text-teal-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                            title="Right-to-Left"
                                        >
                                            RTL
                                        </button>
                            ...
                            <div>
                                <label className="mb-1 block text-[10px] font-bold uppercase text-gray-400">Styling</label>
                                <div className="studio-inspector-segmented">
                                    <button
                                        onClick={() => handleStyleChange('fontWeight', effectiveElement.style?.fontWeight === 'bold' ? 'normal' : 'bold')}
                                        className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.fontWeight === 'bold' ? 'bg-teal-100 text-teal-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                        title="Bold"
                                    >
                                        <Bold size={16} />
                                    </button>
                                    <button
                                        ...
                                        className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.fontStyle === 'italic' ? 'bg-teal-100 text-teal-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                        title="Italic"
                                    >
                                        <Italic size={16} />
                                    </button>
                                    <button
                                        ...
                                        className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.textDecoration === 'underline' ? 'bg-teal-100 text-teal-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                        title="Underline"
                                    >
                                        <Underline size={16} />
                                    </button>
                                    <button
                                        ...
                                        className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.textDecoration === 'line-through' ? 'bg-teal-100 text-teal-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                        title="Strikethrough"
                                    >
                            ...
                            {selectedElement.type === 'button' && (
                                <div>
                                    <label className="mb-1 block text-[10px] font-bold uppercase text-gray-400">Vertical</label>
                                    <div className="studio-inspector-segmented">
                                        <button
                                            onClick={() => handleStyleChange('verticalAlign', 'top')}
                                            className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.verticalAlign === 'top' ? 'bg-emerald-100 text-emerald-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                            title="Align Top"
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.verticalAlign === 'middle' || !effectiveElement.style?.verticalAlign ? 'bg-emerald-100 text-emerald-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                            title="Align Middle"
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`studio-inspector-segmented-button flex-1 flex justify-center ${effectiveElement.style?.verticalAlign === 'bottom' ? 'bg-emerald-100 text-emerald-800' : 'hover:bg-gray-100 text-gray-700'}`}
                                            title="Align Bottom"
                                        >
